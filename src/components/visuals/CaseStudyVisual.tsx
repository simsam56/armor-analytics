...
export function AgroVisual({ className = '' }: VisualProps) {
  return (
    ...
    >
      ...
      {/* Data flow arrows */}
      <path d="M200 45 L200 30 L280 30 L280 60" stroke="#3b82f6" strokeWidth="2" strokeDasharray="4" />
      ...
      <text x="320" y="66" fill="#94a3b8" fontSize="8" fontFamily="monospace">-42% waste</text>
...
export function MetallurgieVisual({ className = '' }: VisualProps) {
  return (
    ...
    >
      ...
      <path d="M200 100 L240 100 L240 50 L280 50" stroke="#3b82f6" strokeWidth="2" strokeDasharray="4" />
      ...
      {/* Metrics */}
      <text x="340" y="55" fill="#22c55e" fontSize="8" fontFamily="monospace">98%</text>
      <text x="340" y="62" fill="#64748b" fontSize="6">uptime</text>

      <rect x="290" y="75" width="80" height="25" fill="#334155" rx="2" />
      <text x="300" y="90" fill="#94a3b8" fontSize="8" fontFamily="monospace">+2.5h/jour</text>
...
export function PlasturgieVisual({ className = '' }: VisualProps) {
  return (
    ...
    >
      ...
      <text x="300" y="54" fill="#22c55e" fontSize="10" fontFamily="monospace">Cycle: 12s</text>

      {/* Quality metrics */}
      <rect x="290" y="65" width="35" height="25" fill="#334155" rx="2" />
      <text x="295" y="80" fill="#22c55e" fontSize="8" fontFamily="monospace">99.2%</text>
      <text x="295" y="88" fill="#64748b" fontSize="6">qualité</text>

      <rect x="330" y="65" width="40" height="25" fill="#334155" rx="2" />
      <text x="335" y="80" fill="#3b82f6" fontSize="8" fontFamily="monospace">-15%</text>
      <text x="335" y="88" fill="#64748b" fontSize="6">rebuts</text>

      {/* Data flow */}
      <path d="M80 90 L80 50 L270 50 L270 65" stroke="#3b82f6" strokeWidth="2" strokeDasharray="4" />
...
export function IndustrialVisual({ className = '' }: VisualProps) {
  return (
    ...
    >
      ...
      {/* Connection lines */}
      <path d="M150 100 L200 100 L200 60 L220 60" stroke="#3b82f6" strokeWidth="2" strokeDasharray="4" />
      ...
      <text x="220" y="140" fill="#22c55e" fontSize="12" fontFamily="monospace">+35%</text>
      <text x="218" y="152" fill="#64748b" fontSize="7">productivité</text>

      <rect x="260" y="120" width="45" height="40" fill="#334155" rx="2" />
      <text x="272" y="140" fill="#3b82f6" fontSize="12" fontFamily="monospace">-8h</text>
      <text x="268" y="152" fill="#64748b" fontSize="7">par semaine</text>

      <rect x="310" y="120" width="50" height="40" fill="#334155" rx="2" />
      <text x="320" y="140" fill="#f59e0b" fontSize="12" fontFamily="monospace">ROI</text>
      <text x="318" y="152" fill="#64748b" fontSize="7">démontrable</text>
    </svg>
  );
}
...
export function HeroIllustration({ className = '' }: VisualProps) {
  return (
    ...
    >
      ...
      <text x="120" y="65" textAnchor="middle" fill="#991b1b" fontSize="12" fontWeight="600">AVANT</text>

      {/* Messy desk with papers */}
      <rect x="40" y="90" width="160" height="80" fill="#fecaca" rx="4" />

      {/* Scattered papers */}
      <rect x="50" y="100" width="30" height="40" fill="white" rx="2" transform="rotate(-5 50 100)" />
      <rect x="85" y="95" width="30" height="40" fill="white" rx="2" transform="rotate(8 85 95)" />
      <rect x="120" y="100" width="30" height="40" fill="white" rx="2" transform="rotate(-3 120 100)" />
      <rect x="155" y="98" width="30" height="40" fill="white" rx="2" transform="rotate(10 155 98)" />
      ...
      <text x="65" y="235" textAnchor="middle" fill="#ef4444" fontSize="10" fontWeight="bold">8h</text>

      {/* ARROW in middle */}
      <rect x="230" y="120" width="40" height="60" fill="#3b82f6" rx="4" />
      <polygon points="270,150 290,150 280,165" fill="#3b82f6" />
      <text x="250" y="145" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">AUTO</text>
      <text x="250" y="157" textAnchor="middle" fill="white" fontSize="8">MATION</text>

      {/* AFTER Section - Right side */}
      <rect x="280" y="40" width="200" height="220" fill="#f0fdf4" rx="8" />
      <text x="380" y="65" textAnchor="middle" fill="#166534" fontSize="12" fontWeight="600">APRES</text>

      {/* Clean dashboard */}
      <rect x="300" y="90" width="160" height="80" fill="#dcfce7" rx="4" />

      {/* Dashboard screens */}
      <rect x="310" y="100" width="65" height="60" fill="white" rx="4" stroke="#22c55e" strokeWidth="2" />
      <rect x="385" y="100" width="65" height="60" fill="white" rx="4" stroke="#22c55e" strokeWidth="2" />
      ...
      <text x="417" y="125" textAnchor="middle" fill="#22c55e" fontSize="16" fontWeight="bold">+35%</text>
      <text x="417" y="145" textAnchor="middle" fill="#64748b" fontSize="8">productivité</text>
      ...
      <text x="435" y="235" textAnchor="middle" fill="#22c55e" fontSize="8" fontWeight="bold">30min</text>
    </svg>
  );
}
...
export function MetricsBeforeAfter({ className = '' }: VisualProps) {
  return (
    ...
    >
      ...
      <text x="90" y="85" textAnchor="middle" fill="#dc2626" fontSize="18" fontWeight="bold">8h/jour</text>
      <text x="90" y="100" textAnchor="middle" fill="#64748b" fontSize="9">ressaisies manuelles</text>

      <rect x="155" y="60" width="110" height="50" fill="white" rx="4" />
      <text x="210" y="85" textAnchor="middle" fill="#dc2626" fontSize="18" fontWeight="bold">3 jours</text>
      <text x="210" y="100" textAnchor="middle" fill="#64748b" fontSize="9">pour un reporting</text>

      <rect x="35" y="120" width="110" height="50" fill="white" rx="4" />
      <text x="90" y="145" textAnchor="middle" fill="#dc2626" fontSize="18" fontWeight="bold">15%</text>
      <text x="90" y="160" textAnchor="middle" fill="#64748b" fontSize="9">taux d&apos;erreur</text>

      <rect x="155" y="120" width="110" height="50" fill="white" rx="4" />
      <text x="210" y="145" textAnchor="middle" fill="#dc2626" fontSize="18" fontWeight="bold">0</text>
      <text x="210" y="160" textAnchor="middle" fill="#64748b" fontSize="9">visibilité temps réel</text>
      ...
      <text x="390" y="85" textAnchor="middle" fill="#16a34a" fontSize="18" fontWeight="bold">30min</text>
      <text x="390" y="100" textAnchor="middle" fill="#64748b" fontSize="9">supervision auto</text>

      <rect x="455" y="60" width="110" height="50" fill="white" rx="4" />
      <text x="510" y="85" textAnchor="middle" fill="#16a34a" fontSize="18" fontWeight="bold">Temps réel</text>
      <text x="510" y="100" textAnchor="middle" fill="#64748b" fontSize="9">reporting automatisé</text>

      <rect x="335" y="120" width="110" height="50" fill="white" rx="4" />
      <text x="390" y="145" textAnchor="middle" fill="#16a34a" fontSize="18" fontWeight="bold">&lt;1%</text>
      <text x="390" y="160" textAnchor="middle" fill="#64748b" fontSize="9">taux d&apos;erreur</text>

      <rect x="455" y="120" width="110" height="50" fill="white" rx="4" />
      <text x="510" y="145" textAnchor="middle" fill="#16a34a" fontSize="18" fontWeight="bold">100%</text>
      <text x="510" y="160" textAnchor="middle" fill="#64748b" fontSize="9">données accessibles</text>
    </svg>
  );
}
