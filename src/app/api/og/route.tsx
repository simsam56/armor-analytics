...
export async function GET(request: NextRequest) {
  ...
  const subtitle = searchParams.get('subtitle') || 'Collectif data spécialisé PME industrielles bretonnes';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', marginBottom: '24px' }}>
          ...
          <span style={{ fontSize: '28px', fontWeight: 300, color: '#00B4D8', letterSpacing: '3px' }}>ia</span>
        </div>
